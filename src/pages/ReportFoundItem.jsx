...
const ReportFoundItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Image is mandatory for found items
    if (!formData.image) {
      alert('Image is required for found items. Please upload a clear photo.');
      return;
    }

    // Ensure we have coordinates
    if (!selectedLocation) {
      alert('Please search your location or click on the map to set a pin.');
      return;
    }
    ...
    // Log success message
    console.log('Found item report saved successfully:', itemData);
    ...
    try {
      ...
      form.append('date_found', itemData.date);
      ...
      await ApiService.createFoundItem(form);
    } catch (err) {
      console.error('API save failed (found item):', err);
    }
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-10 anim-fade-in-up">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto px-4">
            Please provide details about the item you found to help us reunite it with its owner
          </p>
        </div>

        {/* Main Form Card */}
        <div className="backdrop-blur-md bg-gray-800/50 rounded-3xl shadow-2xl border border-gray-700 anim-fade-in-up-delayed">
          {/* Form Header Accent */}
          <div className="h-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-t-3xl"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-x-4 sm:gap-x-6 md:gap-x-8 gap-y-4 sm:gap-y-6">
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400
                             focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 hover-lift"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-3 rounded-xl bg-green-600 text-white hover:bg-green-500 transition hover-lift text-sm sm:text-base whitespace-nowrap"
                          title="Set on map"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-3 rounded-xl bg-emerald-600 text-white hover:bg-emerald-500 transition hover-lift text-sm sm:text-base whitespace-nowrap"
                ...
                <div className="col-span-2">
                  ...
                  {!formData.image && (
                    <p className="mt-2 text-sm text-red-400">An image is required to submit a found item.</p>
                  )}
                </div>
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400
                             focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200"
                    placeholder="Please provide detailed description of the found item..."
                  />
                </div>
              ...
              <div className="flex justify-center pt-6">
                <button
                  type="submit"
                  className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-xl
                           hover:from-green-600 hover:to-emerald-700 transform hover:scale-105 transition-all duration-200
                           focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 hover-lift"
                >
                  Submit Report
                </button>
              </div>
